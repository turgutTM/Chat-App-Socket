...
const Profile = ({ profileId }) => {
  ...
  const handleProfilePhotoUpload = (res) => {
    ...
    setProfilePhoto(res[0].url); // Update profile photo URL
  ...
  return (
    <div className="bg-gradient-to-r from-[#ffffff] to-[#ffffff] rounded-3xl h-full">
      <div className="flex flex-col h-full items-center gap-2">
        ...
        <div className="mt-16 border-black border-[3px] rounded-full w-48 h-48 relative">
          <img
            className="w-full rounded-full"
            src={profilePhoto || "/batman.jpg"}
          />
        </div>
        {user._id === profileId && isEditing && (
          <div className="mt-4">
